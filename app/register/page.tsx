        ...
        <div className="relative group">
          ...
          <div className="relative bg-white dark:bg-gray-800/90 backdrop-blur-xl border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 md:space-y-6">
            ...
            >
              ...
              {invitation && (
                <div className="mt-2 sm:mt-3 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl text-gray-900 dark:text-white cursor-not-allowed opacity-75"
            ...
            <motion.div
              ...
              className="text-center pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-700"
            >
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                Bereits ein Konto?{' '}
                <Link
