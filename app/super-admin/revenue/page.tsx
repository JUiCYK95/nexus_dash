...
export default function RevenuePage() {
  ...
  async function checkSuperAdmin() {
    try {
      ...
      if (!user) {
        router.push('/login?redirect=/super-admin/revenue')
        return
      }
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="bg-gray-800 shadow-xl border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Umsatz-Übersicht</h1>
              <p className="text-sm text-gray-400 mt-1">Umsatzstatistiken</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gray-800 p-8 rounded-lg shadow text-center">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Umsatz-Dashboard</h3>
